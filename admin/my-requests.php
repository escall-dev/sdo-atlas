...
<div class="data-card">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="cell-secondary"><?php echo htmlspecialchars(substr($request['purpose_of_travel'], 0, 50)); ?>...</div>
                        <?php endif; ?>
                    </td>
                    <td>
                        <div class="cell-primary"><?php echo date('M j, Y', strtotime($request['created_at'])); ?></div>
                        <div class="cell-secondary"><?php echo date('g:i A', strtotime($request['created_at'])); ?></div>
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        <div class="cell-primary"><?php echo htmlspecialchars($request['approver_name'] ?? $request['approving_authority_name'] ?? '-'); ?></div>
                        <div class="cell-secondary"><?php echo $request['approval_date'] ? date('M j, Y', strtotime($request['approval_date'])) : ''; ?></div>
                    ...
                    <td>
                        <div class="action-buttons">
                            <?php 
                            $viewUrl = $request['request_type'] === 'ls' 
                                ? navUrl('/locator-slips.php?view=' . $request['id'])
                                : navUrl('/authority-to-travel.php?view=' . $request['id']);
                            ?>
                            ...
                            <?php if ($request['status'] === 'approved'): ?>
                            <?php 
                            $downloadUrl = $request['request_type'] === 'ls'
    ...
    <div class="pagination">
        ...
        <div class="pagination-links">
            <?php if ($page > 1): ?>
            <a href="<?php echo navUrl('/my-requests.php?type=' . $type . '&status=' . $status . '&page=' . ($page - 1)); ?>" class="page-link">
